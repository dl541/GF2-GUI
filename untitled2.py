...
class MyGLCanvas(wxcanvas.GLCanvas):
    ...
    def __init__(self, parent, devices, monitors):
        ...
        #signal_dict for testing
        self.signal_dict = {}
        self.signal_dict['monitor 1'] = ['HIGH','HIGH','HIGH','HIGH','FALLING','LOW','LOW']
        self.signal_dict['monitor 2'] = ['LOW','LOW','BLANK','RISING','HIGH']
        
        # Initialise colour schemes (TODO: change this for monitors later)
        self.color = {}
    ...
    def render(self, text):
        ...
        self.display_signal_prototype(self.signal_dict)
...
#        GL.glEnd()
#
#        GL.glColor3f(0.0, 1.0, 0.0)  # signal trace is blue
#        GL.glBegin(GL.GL_LINE_STRIP)
#        for i in range(10):
#            x = (i * 20) + 10
#            x_next = (i * 20) + 30
